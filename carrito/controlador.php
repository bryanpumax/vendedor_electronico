        ...
        case 'btn_accion_modal':
                switch ($_REQUEST["accion"]) {
                        case '1':
                                ...
                                break;
                        case '2':
                                echo  $_SESSION["correo_cliente"] . $_REQUEST["facturacion"];
                                break;
                        case '3':
                                echo  $_SESSION["correo_cliente"] . $_REQUEST["facturacion"];
                                break;
...
{
        if ((actualizar("tbl_facturacion", "documento='$baucher',estado_facturacion='Baucher ingresado'", "id_facturacion='$id_factura'")) == true) {
                echo "Baucher registrado";
        } else {
