...
$ruta='../'.$_POST['ruta'].'/index.php';
  ...
  correo($correoquien,$nombrequien,$asunto,$mensaje,$ruta);  }
  else{
    $correoquien=$_POST['correoquien'];
    $nombrequien=$_POST['nombrequien'];
    $asunto=$_POST['asunto'];
    $cedula=$_POST['cedula'];
    $mensaje=$_POST['mensaje']." Por favor enviarme a mi correo electronico:".$correoquien." mi cedula es: ".$cedula." soy del Instituto Gabriela Mistral";
$ruta="../../../";
$correoquien2="admin@lab-mrtecks.com";
...
function correo2($correoquien,$nombrequien,$asunto,$mensaje){
